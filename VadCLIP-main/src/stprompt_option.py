...
parser = argparse.ArgumentParser(description='STPrompt')
...
parser.add_argument('--model-path', default='model/model_stprompt_xd.pth')
parser.add_argument('--use-checkpoint', default=False, type=bool)
parser.add_argument('--checkpoint-path', default='model/stprompt_checkpoint.pth')
...
parser.add_argument('--alpha', default=1.0, help='weight for alignment loss')
parser.add_argument('--beta', default=0.1, help='weight for contrastive loss')
